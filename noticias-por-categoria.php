...
<div class="row my-1 mx-md-n1">
    ...
    <article class="col-12">
        ...
        <h2 class=" ">Notícias sobre <span class="badge bg-primary"><?= $dados[0]["categoria"] ?></span> 
    </h2>
    <?php } else{ ?>
        <h2 class="alert alert-warning text-center"> 
            Não há notícia desta categoria
         </h2>
         <?php } ?>
                ...
                <div class="list-group">
                    <?php foreach ($dados as $itemNoticia) { ?>
                        <a href="noticia.php?id=<?= $itemNoticia['id'] ?>" class="list-group-item list-group-item-action">
                            ...
                            <p><time><?=Utilitarios::formatarData($itemNoticia['data'])?></time>
                                <?= $itemNoticia['autor'] ?></p>
